...
const api: RendererApi = {
  ...
  checkAgentStart: (paneId, profile, cwd) => ipcRenderer.invoke('agent:check-start', paneId, profile, cwd),
  checkAgentProfile: profile => ipcRenderer.invoke('agent:check-profile', profile),
  prepareAgentStatus: (paneId, profile) => ipcRenderer.invoke('agent:prepare', paneId, profile),
